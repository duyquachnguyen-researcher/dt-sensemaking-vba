"""Analyze statement differences by country for Q14."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Q14 country difference analysis")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output-csv",
        type=Path,
        default=Path("outputs/q14_statement_country_gaps.csv"),
...
def summarize(stats: list[dict[str, Any]], top_n: int) -> str:
    lines = [
        ...
        "",
        "Top country-separated statements",
        "---------------------------------",
    ]
...
def main() -> None:
    ...
    group_map = load_group_map(args.participants, "country")
    ...
    sanity_lines = [
        ...
        f"Statements with >=2 countries: {len(stats)}",
    ]
