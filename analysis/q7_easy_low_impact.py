"""Analyze statements that are easy to implement but low impact for Q7."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Q7 easy-to-implement, low-impact analysis")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output-csv",
        type=Path,
        default=Path("outputs/q7_easy_low_impact.csv"),
        help="Output CSV path",
    )
    parser.add_argument(
        "--output-summary",
        type=Path,
        default=Path("outputs/q7_summary.txt"),
    ...
    parser.add_argument(
        ...
        type=float,
        default=5.0,
        help="Min centroid X value for easy-to-implement",
    )
    parser.add_argument(
        "--y-threshold",
        type=float,
        default=3.0,
        help="Max centroid Y value for low-impact",
    )
    parser.add_argument(
        "--top-n",
        type=int,
...
def summarize(
    ...
    lines = [
        "Q7 Easy-to-Implement / Low-Impact Summary",
        "========================================",
